...
### Added
- JavaScript and TypeScript callgraph parsing now covers ES module and CommonJS imports, imported/direct calls, lifecycle receiver and assignment fields, fluent-chain IDs, and source columns. (#66)
