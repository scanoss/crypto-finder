...
func TestLoadEmbeddedJavaIncludesTier0GapContracts(t *testing.T) {
	...
	tests := []struct {
		...
		{"io.jsonwebtoken.JwtParserBuilder.build", 0, "io.jsonwebtoken.JwtParser", "jjwt-0.11"},
		{"io.jsonwebtoken.JwtParser.parseSignedClaims", 1, "io.jsonwebtoken.Jws", "jjwt-0.12"},
...
func TestLoadEmbeddedJavaIncludesIssue138LifecycleContracts(t *testing.T) {
	...
	tests := []struct {
		...
		{"com.google.crypto.tink.integration.awskms.AwsKmsClient.<init>", 0, "com.google.crypto.tink.integration.awskms.AwsKmsClient", "factory", "tink-awskms"},
		{"com.google.crypto.tink.integration.awskms.AwsKmsClient.getAead", 1, "com.google.crypto.tink.Aead", "factory", "tink-awskms"},
		{"com.google.crypto.tink.integration.gcpkms.GcpKmsClient.register", 2, "void", "factory", "tink-gcpkms"},
		{"com.google.crypto.tink.integration.gcpkms.GcpKmsClient.getAead", 1, "com.google.crypto.tink.Aead", "factory", "tink-gcpkms"},
